...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let answer = "";
  $$result.css.add(css);
  return `<main class="svelte-hgozrj"><h1 class="svelte-hgozrj">Otázka 3</h1>
<p class="svelte-hgozrj">!(!((true || false) &amp;&amp;<br class="svelte-hgozrj"> (!false &amp;&amp; true)))<br class="svelte-hgozrj"> bude vždy true nebo false?</p>
