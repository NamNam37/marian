...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let answer = 0;
  $$result.css.add(css);
  return `<main class="svelte-hgozrj"><h1 class="svelte-hgozrj">Otázka 2</h1>
<p class="svelte-hgozrj">-7 v binární soustavě při<br class="svelte-hgozrj"> použití doplňkového kódu</p>
